...
function useLink(props) {
  ...
  function navigate(e = {}) {
    if (guardEvent(e)) {
      return router[unref(props.replace) ? "replace" : "push"](unref(props.to)).catch(noop3);
    }
...
function createRouter(options) {
  ...
  function setupListeners() {
    removeHistoryListener = routerHistory.listen((to, _from, info) => {
      ...
      if (shouldRedirect) {
        pushWithRedirect(assign(shouldRedirect, { replace: true }), toLocation).catch(noop3);
        return;
      }
...
export { Fragment as F, popScopeId as a, createVNode as b, createBlock as c, defineComponent as d, withDirectives as e, createTextVNode as f, createRouter as g, createWebHashHistory as h, faLinkedin as i, faGithub as j, faTwitter as k, library as l, createI18n as m, createApp as n, openBlock as o, pushScopeId as p, FontAwesomeIcon as q, resolveComponent as r, toDisplayString$1 as t, useI18n as u, vModelSelect as v, withScopeId as w };
